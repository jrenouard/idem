...
* Ajouter 2 select, Région et Ville qui sont remplis en ajax en fonction du choix du Pays -> Région. Vous pouvez utiliser les tables suivantes [geo.sql.zip](geo.sql.zip)
